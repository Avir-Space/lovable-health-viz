...
export default function AirworthinessManagement() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-3xl font-bold mb-2">Airworthiness Management</h1>
        <p className="text-muted-foreground">
          Monitor fleet airworthiness, regulatory compliance and audit performance
        </p>
      </div>
