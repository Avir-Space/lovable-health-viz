...
export default function FinancialProcurement() {
  const { kpis, isLoading, error } = useDashboardKpis('financial-procurement');
  ...
  return (
    <div className="space-y-6 p-6">
      <div>
        <h1 className="text-2xl font-semibold">Financial & Procurement</h1>
        <p className="text-sm text-muted-foreground">Budget vs actuals, AOG cost impact, procurement flows</p>
      </div>
